...
7. [Analisis Implementasi](#7-analisis-implementasi)
    - [7.1 Arsitektur Sistem](#71-arsitektur-sistem)
    - [7.2 Manual Version - State Machine](#72-manual-version---state-machine)
    - [7.3 Flowable Version - BPMN Engine](#73-flowable-version---bpmn-engine)
