...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Header */}
      <header className="bg-gradient-to-r from-indigo-900 via-indigo-800 to-indigo-700 text-white shadow-xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-indigo-200 text-sm">PT. Len Industri (Persero)</p>
              </div>
            </div>
            <div className="text-right hidden md:block">
              <p className="text-sm font-medium text-indigo-100">Versi: Flowable BPM</p>
              <p className="text-xs text-indigo-300">Backend: Port 8200</p>
            </div>
          </div>
        </div>
      </header>
