...
export default function HRApproval() {
  ...
  const fetchPendingRequests = async () => {
    try {
      setLoading(true);
      const response = await leaveApi.getPendingHRApproval();
  ...
  const handleApprove = async (id: string) => {
    ...
    try {
      ...
      await leaveApi.hrApprove(id, approvalData);
  ...
  const handleReject = async (id: string) => {
    ...
    try {
      ...
      await leaveApi.hrReject(id, rejectionData);
  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Approval HR</h2>
          <p className="text-gray-500 text-sm mt-1">Kelola pengajuan cuti yang menunggu persetujuan HR</p>
        </div>
        <button 
      ...
      <div className="card mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-800">Identitas Approver HR</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="form-label">
              Nama HR <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              value={approverName}
        ...
        <div className="card">
          <div className="empty-state">
            ...
            <p className="empty-state-description">
              Semua pengajuan cuti telah diproses oleh HR. Silakan refresh untuk memperbarui data.
            </p>
          ...
          {requests.map((request, index) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="status-badge status-manager-approved">
              ...
              {request.managerComment && (
                <div className="mb-4 bg-blue-50 border border-blue-100 rounded-lg p-3">
                  <p className="text-blue-600 text-xs font-medium mb-1">Komentar Manager:</p>
                  <p className="text-gray-700 text-sm">{request.managerComment}</p>
                </div>
              )}
