...
import com.len.leave.deboot.service.DebootLeaveWorkflowService;
...
public class LeaveRequestController {
    ...
    private final DebootLeaveWorkflowService leaveWorkflowService;
    ...
    public ResponseEntity<ApiResponse<LeaveRequestDTO.Response>> managerApprove(
        ...
        LeaveRequestDTO.Response response = leaveWorkflowService.approveByManager(id, approval);
    ...
    public ResponseEntity<ApiResponse<LeaveRequestDTO.Response>> managerReject(
        ...
        LeaveRequestDTO.Response response = leaveWorkflowService.rejectByManager(id, rejection);
    ...
    public ResponseEntity<ApiResponse<LeaveRequestDTO.Response>> hrApprove(
        ...
        LeaveRequestDTO.Response response = leaveWorkflowService.approveByHR(id, approval);
    ...
    public ResponseEntity<ApiResponse<LeaveRequestDTO.Response>> hrReject(
        ...
        LeaveRequestDTO.Response response = leaveWorkflowService.rejectByHR(id, rejection);
