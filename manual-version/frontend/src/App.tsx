    ...
    <div className="min-h-screen">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">PT. Len Industri (Persero)</p>
              </div>
            </div>
            <div className="text-right hidden md:block">
              <p className="text-sm font-medium text-blue-100">Versi: Manual Workflow</p>
              <p className="text-xs text-blue-300">Backend: Port 8101</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-gray-800 text-gray-400 py-6 mt-auto">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm">Sistem Pengajuan Cuti - PT. Len Industri (Persero)</p>
